...
const JumbotronView = () => {
    return (
        <div className="flex flex-row bg-gradient-to-r from-fuchsia-600 to-fuchsia-400 text-white">
            <div className="flex flex-col justify-center p-10">
                <h1 className="text-7xl pb-3">Coming Home</h1>
                ...
                <div className="pt-12 flex justify-end">
                    <button>
                        <Link
                            ...
                            offset={-70}
                            duration={500}
                            className="w-36 p-2 my-5 flex justify-center items-center text-fuchsia-600 bg-white border rounded-md hover:font-bold duration-150"
                        >
                            Contact Us
                        </Link>
                    </button>
