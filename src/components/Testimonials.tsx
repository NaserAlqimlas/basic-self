            ...
            <div className="grid md:grid-cols-3 m-10">
                ...
                <div className="m-10">
                    <p>
                        ...
                        planet! Thank you for the light you brought into my
                        life”{" "}
                    </p>
                    <p>A.M. - Communication & Autism Therapist, Saudi Arabia</p>
                </div>
                <div className="m-10">
                    <p>
